...
COMMENT ON COLUMN "MAKER"."MEMBER_NO" IS '회원번호(SEQ_MEMBER_NO)';

COMMENT ON COLUMN "MAKER"."BOARD_NO" IS '피드 번호(SEQ_BOARD_NO)';
...
ALTER TABLE "MAKER" ADD CONSTRAINT "FK_BOARD_TO_MAKER_1" FOREIGN KEY (
	"BOARD_NO"
)
REFERENCES "BOARD" (
	"BOARD_NO"
