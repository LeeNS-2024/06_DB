...
SELECT * FROM BOARD WHERE BOARD_NO > 6000;
...
SELECT
		...
		(SELECT COUNT(*)
		 FROM BOARD_LIKE L
		 WHERE L.BOARD_NO = 6008) AS LIKE_COUNT,
		(SELECT IMG_PATH || IMG_RENAME
		 FROM BOARD_IMG I
		 WHERE I.BOARD_NO = 2013) AS THUMBNAIL
...
INSERT INTO "COMMENT"
VALUES( SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1-1',
	    DEFAULT,  DEFAULT, 1,  6009, 24004 
);
INSERT INTO "COMMENT"
VALUES( SEQ_COMMENT_NO.NEXTVAL, '자식 댓글 1-1-2',
	    DEFAULT,  DEFAULT, 1,  6009, 24004 
);
